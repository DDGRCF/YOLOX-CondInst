...
from yolox.utils import (DictAction, fuse_model, get_model_info, 
                         postprocess, vis, merge_parsers)
...
def make_parser():
    ...
    parser.add_argument("--vis_conf_thre", default=0.3, type=float, help="the conf for vis")
...
class Predictor(object):
    def __init__(
        ...
        self.vis_conf_thre=vis_conf_thre
    ...
    def visual(self, output, img_info, cls_conf=0.35):
        ...
        vis_res = vis(img, bboxes, scores, clses, masks, cls_conf, self.cls_names)
        return vis_res
...
def image_demo(predictor, vis_folder, path, current_time, save_result):
    ...
    for image_name in files:
        ...
        result_image = predictor.visual(outputs, img_info, predictor.vis_conf_thre)
        if save_result:
...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    while True:
        ...
        if ret_val:
            ...
            result_frame = predictor.visual(outputs[0], img_info, predictor.vis_conf_thre)
            if args.save_result:
...
def main(exp, args):
    ...
    predictor = Predictor(
        model, exp, args.vis_conf_thre, COCO_CLASSES, trt_file, decoder,
