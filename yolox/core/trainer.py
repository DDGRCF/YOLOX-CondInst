...
class Trainer:
    def __init__(self, exp, args):
        ...
        self.best_ap = 0
        self.no_validate = exp.no_validate 
    ...
    def before_epoch(self):
        ...
        if self.epoch + 1 == self.max_epoch - self.exp.no_aug_epochs or self.no_aug:
            ...
            if self.is_distributed:
                self.model.module.head.use_extra_reg = True
            else:
                self.model.head.use_extra_reg = True
            if not self.no_validate:
    ...
    def evaluate_and_save_model(self):
        ...
        self.save_ckpt("last_epoch", 
                metric[self.save_metric][1] > self.best_ap)
        self.best_ap = max(self.best_ap, metric[self.save_metric][1])
