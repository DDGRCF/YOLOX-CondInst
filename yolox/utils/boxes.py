...
def postprocess(prediction, 
    ...
    Args:
        ...
        conf_thre (float, optional): [description]. Defaults to 0.7.
        nms_thre (float, optional): [description]. Defaults to 0.45.
        class_agnostic (bool, optional): [description]. Defaults to False.

    Returns:
        bboxes, clses, scores, [None, ...](for mask)
    """
    ...
    return bbox_output, cls_output, score_output, [None for _ in range(len(bbox_output))]
